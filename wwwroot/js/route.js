class Route {
    ...
    buildID() {
        ...
        $(`<span>Section: </span><span class="route-section-letter">${this.section}</span>`).appendTo(domSection);
    ...
    buildGrip() {
        var gripColors = createGripColors('#' + leftPad((this.gripColor >>> 8).toString(16), 6));
    ...
    buildBy() {
        ...
        $(`<span>Made by:</span><span class="author-name">${this.author}</span>`).appendTo(domBy);
